...
####===V4.1  analyse TP1 et TP2 
import pandas as pd

# === CONFIGURATION ===
FILENAME = "backtest_results.csv"
STRATEGY_NAME = "ob_rsi_ema100pips"  ####==== a changer pour chaque analyse 
...
global_stats = pd.DataFrame({
    "Metric": ["Total Trades", "TP1", "SL", "NONE", "Winrate Global", "% Buy", "% Sell", "Buy Winrate", "Sell Winrate"],
    "Value": [total_trades, tp, sl, none, winrate, buy_pct, sell_pct, buy_winrate, sell_winrate]
})
...
# Sécurité : ajoute les colonnes manquantes si elles n'existent pas
for col in ["TP2", "SL"]:
...
print("✅ Analyse V4.1 avec TP2 et stats heure par heure terminée.")
