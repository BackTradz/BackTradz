...
from app.routes import user_routes  # ou le nom du fichier .py

from app import auth  # ← déjà fait chez toi normalement

from fastapi.responses import JSONResponse, RedirectResponse
# backend/main.py (extrait)
from app.core.paths import ensure_storage_dirs

from    app.routes.a_savoir_routes import router as a_savoir_router

#from backend.utils.templates import templates  # NOTE: utilisé côté rendu templates si besoin
from app.core.config import FRONTEND_URL, PUBLIC_API_URL

from app.routes.official_data_routes import router as official_data_router
...
from app.routes import frontend_routes
from app.routes import pricing_routes
from app.routes.paypal_routes import router as paypal_router
from app.routes.crypto_routes import router as crypto_router


from fastapi_utils.tasks import repeat_every
from app.utils.subscription_utils import renew_all_subscriptions  # adapte au bon chemin

from app.routes import user_profile_routes
from starlette.middleware.sessions import SessionMiddleware
from app.routes import stripe_routes
from app.routes import top_strategy_routes
from app.routes import auth_reset_routes
